...
class ObjectTest {
    ...
    void should_get_initialization_ordering() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String[] expected = {"Initialization Block first", "Field Initializer", "Initialization Block", "Constructor with argument", "Default constructor"};
        // --end-->
    ...
    void should_get_message_of_var_length_parameters_2() {
        ...
        assertEquals(expected, message);
//        System.out.println(getMessageOfVarLengthParameters("Good", new Object[] {1, 2, 3}));
    }
